...
> This is the project's first build day, so there is no "previous session". The plan below is taken from the [Game Concept Document](../../5.19-Aftertrace%20%E2%80%94%20Game%20Concept%20Document.md) written on 2026-05-19 (the file carries the later *Aftertrace* title after the Session-02 rename).
