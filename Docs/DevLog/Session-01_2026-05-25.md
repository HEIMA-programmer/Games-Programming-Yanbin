...
- [ ] Add cheap juice: pressure-plate press + particle, an echo trail, landing dust, camera
      shake on hard landing / death (`CameraShake` already exists), and a brief hit-stop on death.
